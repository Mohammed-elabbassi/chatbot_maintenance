...
export default function DashboardPage() {
  ...
  return (
    <div className="dashboard">
      {/* ── Animated background (same as LoginPage) ────────────────────── */}
      <div className="dashboard-bg">
        <div className="dashboard-bg-circle c1" />
        <div className="dashboard-bg-circle c2" />
        <div className="dashboard-bg-circle c3" />
      </div>
      ...
      <div className="dashboard-body">
        ...
        {/* ── LEFT: Tenant List — fixed, does not scroll with chat ─────── */}
        <aside className="tenant-panel">
          <h3 className="panel-title">LISTE DES TENANTS</h3>
          <div className="tenant-search">
            <span className="search-icon"> </span>
        ...
        {/* ── CENTER: Chat — only .chat-messages scrolls ───────────────── */}
        <main className="chat-panel">
          <div className="chat-messages">
            {messages.map(msg => (
              <Message
        ...
        {/* ── RIGHT: Response Options — fixed, does not scroll with chat ── */}
        <aside className="options-panel">
          <h3 className="panel-title">OPTIONS DE RÉPONSE</h3>
          <div className="options-list">
            {RESPONSE_MODES.map(mode => (
