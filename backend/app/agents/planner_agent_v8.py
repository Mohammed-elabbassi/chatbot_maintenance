...
# Modules utilisés (après fusion/refactoring) :
#   ✅ intent_classifier_v7   — classification de l'intent              (inchangé)
#   ✅ schema_registry_v7     — schémas de tables + hints de jointure   (inchangé)
#   ✅ example_retriever_v7   — exemples dataset BM25                   (inchangé)
#   ✅ security_executor      — GuardrailsV7 + SQLValidatorV7 + SQLExecutorV7 (fusionné)
#   ✅ llm_pipeline           — PromptBuilderV7 + LLMAgentV8 + SQLRepairV8   (fusionné)
#   ✅ parametric_templates_v6 — templates SQL déterministes            (corrigé)
#   ✅ rag_agent_v8           — Milvus RAG hybride                      (inchangé)
#   ✅ response_formatter_v6  — fallback formatter                      (inchangé)

# Supprimés :
#   ❌ feedback_logger_v6     — retiré sur demande
#   ❌ response_rewriter_v8   — retiré sur demande
# """
...
#                 print(f"[PlannerAgentV8] ⚠️  Milvus indisponible, RAG désactivé : {exc}")
...
#         # Formatter de réponse si SQL réussi et pas encore de réponse naturelle
#         if (
#             state.get("success")
...
"""
Planner Agent V8 — LangGraph + Groq LLaMA 3.1 8B + Milvus RAG Hybride
MODIFIÉ : ajout du paramètre forced_tenant_db dans process_question()
          pour que le frontend puisse forcer le tenant sélectionné.
"""
